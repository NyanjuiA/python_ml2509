...
================================================================================
This script is an improved fruit classification example that compares logistic
regression and decision tree models based on their perfomance using
accuracy and F1 score. The script demonstrates:
