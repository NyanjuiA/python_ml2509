"""
================================================================================
Python script to demonstrate various Pandas data frame operations.
================================================================================
This script demostrate Pandas data frame operations like filtering, grouping,
merging, and other data frame operations.
...
"""
# ================================================================================
# SECTION 0: Import the required module(s)
# ================================================================================
import pandas as pd

# ================================================================================
# SECTION 1: Create and display sample employee and sales dataframes
# ================================================================================
print("---- 1. Create and display sample employee and sales dataframes ----")
...
# ================================================================================
# SECTION 2: Merge the employee and sales dataframes on the 'EmployeeID field.
# ================================================================================
...
department_stats = combined.groupby(['Department']).agg({
   'Salary': ['mean', 'sum', 'max', 'min','median'],
