...
to users on streaming platforms like Amazon Prime, Hulu or Netflix
================================================================================
...
def recommend_movies(movie_title, number_of_recommendations = 3):
   ...
   # Arrange/sort movies based on similarity score (highest first)
   sorted_movies = sorted(similarity_scores, key=lambda x: x[1], reverse=True)

   # Skip the first movies (it's the same as what we're searching recommendations for)
