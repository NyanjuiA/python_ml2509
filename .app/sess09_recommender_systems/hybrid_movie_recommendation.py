"""
================================================================================
Python script to demonstrate a hybrid movie recommendation system for streaming
platforms like Netflix, Hulu or Amazon prime.
It combines content based filtering and collaborative filtering to address
...
# ================================================================================
# NB : For real-world applications, this would come from a DB or some json or csv file
...
# Create a Pandas datafram from the above movies data
...
# ================================================================================
# Generate dummy users and movie ratings (rows -> user, columns -> movies)
ratings_data = {
...
if __name__ == "__main__":
   ...
   print("\nHybrid Recommendations for 'User1', bsed on the movie 'Inception':")
   print(hybrid_recommendation("User1", title="Inception", alpha=0.6))
