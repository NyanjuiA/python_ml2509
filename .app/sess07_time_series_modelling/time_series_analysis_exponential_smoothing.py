...
plt.plot(ses_model.fittedvalues, label='Simple Exponential Smoothing(SES) Fitted Values',color='green')
plt.plot(ses_forecast, label='Simple Exponential Smoothing(SES) Forecast',color='red',linestyle='--')
